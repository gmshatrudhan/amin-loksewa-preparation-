...
window.EXTRA["Compass Survey Introduction"].sub = [
      {q:"Define bearing and differentiate between the whole circle bearing and reduced bearing systems.", marks:10, hint:"A bearing is the horizontal angle which a survey line makes with a reference meridian. WCB system: measured clockwise from north from 0 to 360°, used with the prismatic compass, only one letter free notation. Reduced or quadrantal bearing: measured from north or south, eastward or westward, from 0 to 90°, used with the surveyor's compass, written as N30E or S45W. Conversion: for WCB 0 to 90, RB = WCB (NE); 90 to 180, RB = 180 - WCB (SE); 180 to 270, RB = WCB - 180 (SW); 270 to 360, RB = 360 - WCB (NW)."},
      {q:"What is local attraction? How is it detected and corrected?", marks:5, hint:"Local attraction is the deflection of the magnetic needle from the magnetic meridian caused by nearby magnetic material such as iron pipes, electric poles, rails, steel structures or magnetic rocks. Detection: compute the difference between the fore bearing and back bearing of each line; if it is not exactly 180°, local attraction exists at one or both stations. Correction: identify a line whose FB and BB differ by exactly 180°, so both its stations are free from attraction; starting from those stations, apply the necessary correction progressively to the bearings observed at the affected stations."},
      {q:"Convert the whole circle bearing 210° into the reduced bearing system, showing your working.", marks:5, hint:"The WCB of 210° lies between 180 and 270°, which is the south west quadrant. The reduced bearing = WCB - 180 = 210 - 180 = 30°. Therefore the reduced bearing is S30W."},
