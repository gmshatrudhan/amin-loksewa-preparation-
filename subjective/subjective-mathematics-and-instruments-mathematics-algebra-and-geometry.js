...
window.EXTRA["Mathematics (Algebra & Geometry)"].sub = [
      ...
      {q:"State and prove the Pythagoras theorem with a diagram.", marks:10, hint:"Statement: in a right angled triangle, the square on the hypotenuse is equal to the sum of the squares on the other two sides, that is AC² = AB² + BC². Proof: in triangle ABC right angled at B, draw BD perpendicular to AC. Triangles ADB and ABC are similar, so AB² = AD × AC. Triangles BDC and ABC are similar, so BC² = DC × AC. Adding, AB² + BC² = AC × (AD + DC) = AC × AC = AC². Hence proved. A neat labelled figure must be drawn."},
      {q:"Find the area of a triangle whose sides are 13 m, 14 m and 15 m.", marks:5, hint:"Using Heron's formula: s = (a + b + c)/2 = (13 + 14 + 15)/2 = 21 m. Area = √(s(s-a)(s-b)(s-c)) = √(21×8×7×6) = √7056 = 84 sq m."},
