...
window.EXTRA["Mathematics (Algebra & Geometry)"].mcq = [
      ...
      {q:"The value of (a+b)² − (a−b)² is:", o:["2ab", "4ab", "a²+b²", "0"], a:1, e:"Expanding: (a²+2ab+b²) − (a²−2ab+b²) = 4ab."},
      {q:"The perimeter of a square of side 15 m is:", o:["30 m", "45 m", "60 m", "225 m"], a:2, e:"Perimeter = 4×15 = 60 m; 225 sq m would be its area."},
      {q:"How many sides does a hexagon have?", o:["5", "7", "8", "6"], a:3, e:"Hexagon = 6 sides; pentagon 5, heptagon 7, octagon 8."},
      {q:"If x² = 144, the positive value of x is:", o:["12", "14", "16", "72"], a:0, e:"x = ±12; the positive root is 12."},
      {q:"The sum of the interior angles of a quadrilateral is:", o:["180°", "360°", "270°", "540°"], a:1, e:"(n−2)×180° = 2×180° = 360° for n = 4."},
      {q:"The circumference of a circle of diameter 14 cm (taking pi = 22/7) is:", o:["22 cm", "88 cm", "44 cm", "66 cm"], a:2, e:"C = πd = (22/7)×14 = 44 cm."},
