...
window.EXTRA["Mapping"].mcq = [
      ...
      {q:"Remote sensing means collecting information about objects:", o:["By physical contact", "Without physical contact, using sensors", "Only at night", "Only with total stations"], a:1, e:"Remote sensing uses satellite or aerial sensors to record reflected/emitted energy without touching the object; used for land use and forest mapping."},
      {q:"The Global Positioning System (GPS) consists of how many segments?", o:["Two", "Four", "Five", "Three"], a:3, e:"Three segments: space (satellites), control (ground stations) and user (receivers). GNSS includes GPS, GLONASS, Galileo and BeiDou."},
      {q:"A topographical map mainly shows:", o:["Only property boundaries", "Only satellite images", "Natural and artificial features with relief", "Underground minerals only"], a:2, e:"Topo maps show terrain relief (contours), drainage, vegetation, settlements and infrastructure — the base for planning and engineering."},
      ...
      {q:"The UTM system divides the earth into how many zones?", o:["24 zones", "60 zones", "36 zones", "12 zones"], a:1, e:"UTM has 60 zones of 6° longitude each; Nepal falls in zones 44 and 45. Coordinates are given as eastings and northings."},
      ...
      {q:"Nepal’s national mapping agency, the Survey Department, was established in:", o:["B.S. 2014 (1957 AD)", "B.S. 2025 (1968 AD)", "B.S. 1990 (1933 AD)", "B.S. 2047 (1990 AD)"], a:0, e:"The Survey Department (Napi Bibhag), under the Ministry of Land Management, is responsible for geodetic control, cadastral and topographic mapping of Nepal."}
    ];
