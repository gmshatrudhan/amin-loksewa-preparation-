...
window.EXTRA["Cadastral Survey"].mcq = [
      ...
      {q:"A parcel (kitta) number on a cadastral map uniquely identifies:", o:["A district", "A single land parcel within a sheet", "A municipality", "A survey team"], a:1, e:"Each parcel within a map sheet gets a unique kitta number; combined with sheet number, VDC/municipality and ward it identifies the land."},
      {q:"During cadastral survey, parcel boundaries are fixed on the basis of:", o:["Satellite images only", "Old tax receipts only", "Occupation and evidence shown by owners/neighbours", "Random division"], a:2, e:"The survey team fixes boundaries from on-ground occupation, owner statements, neighbour agreement and available evidence (pilot area approach)."},
      {q:"The control framework for cadastral surveying in Nepal is based on:", o:["Compass bearings only", "Eye estimation", "Chain lines only", "Geodetic control points and traverses"], a:3, e:"Cadastral sheets are tied to national geodetic control through traverses/GPS so parcels fit consistently across sheets."},
      {q:"Sheet numbers on cadastral maps help to:", o:["Locate the map sheet covering an area", "Count the population", "Fix land prices", "Measure crop yield"], a:0, e:"Each map sheet has an index number; the sheet index map shows which sheet covers a given locality for record retrieval."},
      {q:"Kitta-kat (parcel splitting) is required when:", o:["Land is left fallow", "Part of a parcel is sold or partitioned", "Tax is paid", "Crops are changed"], a:1, e:"Subdivision by sale, partition or inheritance requires kitta-kat: field measurement, new parcel numbers and updated map and records."},
      {q:"The field book (filid buk) in cadastral survey records:", o:["Daily wages", "Weather reports", "Measurements, sketches and boundary details", "Court orders"], a:2, e:"The field book contains measured distances, offsets, sketches, owner names and remarks — the legal basis for the cadastral map."},
