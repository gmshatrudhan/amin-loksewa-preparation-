...
window.EXTRA["Traverse and Triangulation"].mcq = [
      ...
      {q:"The latitude of a survey line is its projection on the:", o:["East-west line", "North-south meridian", "Line itself", "Vertical plane"], a:1, e:"Latitude = L·cosθ (N positive); departure = L·sinθ (E positive)."},
      {q:"In the third quadrant (south-west), the signs of latitude and departure are:", o:["+, +", "+, −", "−, −", "−, +"], a:2, e:"SW lines go south (latitude −) and west (departure −)."},
      {q:"The transit rule is preferred over the Bowditch rule when:", o:["Precision required is low", "Angles and distances are equally precise", "Distances are very long", "Angular measurements are more precise than linear ones"], a:3, e:"Transit rule distributes latitude error by latitude and departure error by departure — suited to theodolite traverses with precise angles."},
      {q:"A triangulation triangle should preferably be:", o:["Well-conditioned, with no angle below 30° or above 120°", "Always right angled", "Obtuse angled", "Very flat and narrow"], a:0, e:"Well-conditioned triangles (near-equilateral) give strong fixes; ill-conditioned ones magnify errors."},
      {q:"The base line in triangulation is measured with:", o:["A prismatic compass", "Great precision, using invar tape or EDM", "Rough pacing", "A plane table"], a:1, e:"All triangulation distances scale from the base line, so it is measured to the highest precision."},
      {q:"A satellite station in triangulation is used when:", o:["The weather is bad", "The main station cannot be occupied", "Observing at night", "Sights are short"], a:2, e:"An eccentric/satellite station near an inaccessible point (spire, temple) is occupied and observations reduced to centre."},
