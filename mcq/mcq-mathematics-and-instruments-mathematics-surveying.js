...
window.EXTRA["Mathematics (Surveying)"].mcq = [
      ...
      {q:"1 aana is equal to:", o:["16.9 sq m", "31.8 sq m", "50.9 sq m", "8.45 sq m"], a:1, e:"1 aana = 31.8 sq m; 1 ropani = 16 aana = 508.74 sq m."},
      {q:"1 bigha is equal to:", o:["5,080 sq m", "3,390 sq m", "6,773 sq m", "1,270 sq m"], a:2, e:"1 bigha = 20 kattha ≈ 6,772.63 sq m."},
      {q:"1 paisa (hill land unit) is equal to:", o:["15.9 sq m", "31.8 sq m", "3.97 sq m", "7.95 sq m"], a:3, e:"1 ropani = 64 paisa, so 1 paisa = 508.74/64 ≈ 7.95 sq m."},
      {q:"The trapezoidal rule for area requires offsets at:", o:["Equal intervals", "Only the two ends", "Random points", "Doubled end spacing"], a:0, e:"Area = (interval)×[(first+last)/2 + sum of middles]; Simpson rule additionally needs an even number of strips."},
      {q:"The area of a triangle with base 24 m and height 15 m is:", o:["360 sq m", "180 sq m", "120 sq m", "90 sq m"], a:1, e:"Area = ½×24×15 = 180 sq m."},
      {q:"2 bigha 5 kattha is equal to how many kattha?", o:["25", "30", "45", "50"], a:2, e:"2×20 + 5 = 45 kattha."},
