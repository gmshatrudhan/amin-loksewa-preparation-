...
window.EXTRA["GNSS"].mcq = [
      ...
      {q:"GLONASS is the satellite navigation system of:", o:["The USA", "Russia", "India", "Japan"], a:1, e:"GLONASS, Galileo, BeiDou, NavIC (India) and QZSS (Japan) together with GPS form the GNSS family."},
      {q:"The GPS space segment nominally consists of:", o:["12 satellites", "18 satellites", "24 satellites", "36 satellites"], a:2, e:"24+ satellites in 6 orbital planes ensure at least 4 are visible anywhere, anytime."},
      {q:"DGPS improves positioning accuracy by:", o:["Using bigger antennas", "Flying the receiver higher", "Adding more constellations", "Correcting rover positions with data from a base station"], a:3, e:"The base on a known point computes errors and sends corrections to the rover — metre to decimetre accuracy."},
      {q:"Multipath error in GNSS is caused by:", o:["Signals reflected from nearby surfaces", "Satellite clock faults", "Receiver motion", "Solar flares only"], a:0, e:"Reflections from buildings, water and ground lengthen the path; choke-ring antennas and site selection reduce it."},
      {q:"The control segment of GPS consists of:", o:["User receivers", "Ground monitor and upload stations", "Satellites", "Rover antennas"], a:1, e:"Ground stations track satellites, compute orbits/clocks and upload navigation messages."},
      {q:"The orbit height of GPS satellites is about:", o:["600 km", "2,000 km", "20,200 km", "36,000 km"], a:2, e:"Medium earth orbit (~20,200 km, ~12-hour period); 36,000 km is geostationary height."},
