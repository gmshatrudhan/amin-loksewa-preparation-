...
window.EXTRA["Levelling"].mcq = [
      ...
      {q:"The height of the line of collimation above the datum is called the:", o:["Reduced level", "Height of instrument", "Bench mark", "Change point"], a:1, e:"HI = RL of BM + back sight; unknown RLs = HI − (IS/FS)."},
      {q:"In levelling, the first reading taken on a change point is the:", o:["Back sight", "Intermediate sight", "Fore sight", "Zero reading"], a:2, e:"At a change point the fore sight is read first, then the level moves and a back sight is taken to continue."},
      {q:"The arithmetic check for the height of instrument method is:", o:["ΣBS + ΣFS = ΣIS", "Σrise = Σfall always", "Number of BS equals number of FS", "ΣBS − ΣFS = last RL − first RL"], a:3, e:"The same overall check as rise-and-fall: difference of sight sums equals difference of end RLs."},
      {q:"The surface of still water is an example of a:", o:["Level surface", "Horizontal line", "Vertical plane", "Steep slope"], a:0, e:"A level surface is everywhere perpendicular to gravity; still water takes this shape (curved with the earth)."},
      {q:"Profile levelling is carried out to:", o:["Fix property corners", "Find elevations along a centre line such as a road", "Measure bearings", "Test instruments"], a:1, e:"Longitudinal sections from profile levelling guide road, canal and pipeline gradients; cross-sections show side slopes."},
      {q:"Reciprocal levelling is used to:", o:["Speed up the work", "Double the staff length", "Eliminate collimation and curvature errors across wide gaps", "Train beginners"], a:2, e:"Observing from both banks of a river and averaging cancels collimation, curvature and refraction errors."},
