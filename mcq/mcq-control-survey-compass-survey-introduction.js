...
window.EXTRA["Compass Survey Introduction"].mcq = [
      ...
      {q:"The reduced bearing S 40° E is expressed in the whole circle system as:", o:["40°", "140°", "220°", "320°"], a:1, e:"SE quadrant: WCB = 180° − 40° = 140°."},
      {q:"Magnetic declination is zero on the:", o:["Magnetic equator", "Geographic equator", "Agonic line", "Tropic of Cancer"], a:2, e:"The agonic line joins places of zero declination; isogonic lines join equal declination."},
      {q:"The prism in a prismatic compass is used to:", o:["Magnify the needle", "Level the box", "Mark stations", "Read the graduated ring while sighting"], a:3, e:"The prism reflects the ring graduations to the eye so the observer sights and reads simultaneously."},
      {q:"In a surveyor compass, bearings are measured from:", o:["North and south ends towards east or west", "North clockwise fully round", "South anticlockwise fully round", "East and west ends"], a:0, e:"The surveyor compass reads quadrantal (reduced) bearings from N or S toward E or W."},
      {q:"Local attraction is caused by:", o:["Cloudy weather", "Iron objects and magnetic substances nearby", "High temperature", "Strong wind"], a:1, e:"Iron poles, wires, vehicles and magnetic rock deflect the needle; FB−BB then differs from 180°."},
      {q:"The vertical angle made by a freely suspended magnetic needle with the horizontal is called:", o:["Declination", "Bearing", "Dip of the needle", "Azimuth"], a:2, e:"Magnetic dip varies from 0° at the magnetic equator to 90° at the poles."},
      {q:"The least count of a prismatic compass is usually:", o:["1 degree", "5 minutes", "1 minute", "30 minutes"], a:3, e:"The ring is graduated to 0.5° (30′); readings are estimated to about 15′."}
    ];
